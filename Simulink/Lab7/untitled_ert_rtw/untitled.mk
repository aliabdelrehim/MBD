...
## Generated on : Mon May 04 11:40:11 2026
...
%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/untitled_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/untitled_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/untitled_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/untitled_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(call SPACE_TO_QUESTION,$(START_DIR))/untitled_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.obj : $(call ESCAPE_SPACES,$(START_DIR))/untitled_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


untitled.obj : $(call ESCAPE_SPACES,$(START_DIR))/untitled_ert_rtw/untitled.c
	$(CC) $(CFLAGS) -o "$@" "$<"
